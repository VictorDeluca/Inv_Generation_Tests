...
int main()
{
	unsigned int w = __VERIFIER_nondet_uint(), y = __VERIFIER_nondet_uint();
	unsigned int x = w, z = y;
	...
	assert(!(__VERIFIER_nondet_uint()) && !(c_01*x0 + c_11*w + c_21*x + c_31*y + c_41*z <= d_1));
	//__VERIFIER_assume( -i + -t + -p <= -2);

	assert(!(__VERIFIER_nondet_uint()) && !(c_01*x0 + c_11*w + c_21*x + c_31*y + c_41*z <= d_1) && !(c_02*x0 + c_12*w + c_22*x + c_32*y + c_42*z <= d_2));
	//__VERIFIER_assume(-i + -t + -p <= -1);

	assert((__VERIFIER_nondet_uint()) && !(c_03*x0 + c_13*w + c_23*x + c_33*y + c_43*z <= d_3));
	//__VERIFIER_assume(-i + -t + -p <= -1);
