...
int main()
{
    ...
    __VERIFIER_assume(d_1 >= 1 && d_1 <= 100);     
    int d_2 = __VERIFIER_nondet_int();   
    __VERIFIER_assume(d_2 >= 1 && d_2 <= 100);    
    int d_3 = __VERIFIER_nondet_int(); 
    __VERIFIER_assume(d_3 >= 1 && d_3 <= 100);         

    assert(!(__VERIFIER_nondet_int()) && !(c_01*x0 + c_11*x <= d_1));
    //__VERIFIER_assume( -i + -t + -p <= -2);

    if(__VERIFIER_nondet_int()) x+=2;
    if(__VERIFIER_nondet_int()) x+=2;
    assert(!(__VERIFIER_nondet_int()) && !(c_01*x0 + c_11*x <= d_1) && !(c_02*x0 + c_12*x <= d_2));
    //__VERIFIER_assume(-i + -t + -p <= -1);

    assert((__VERIFIER_nondet_int()) && !(c_03*x0 + c_13*x <= d_3));
    //__VERIFIER_assume(-i + -t + -p <= -1);
