...
int main()
{
    unsigned int n = __VERIFIER_nondet_int(), x = n, y = 0;
    ...
    assert(!(x < 100000000) && !(c_01*x0 + c_11*x <= d_1));
    //__VERIFIER_assume( -i + -t + -p <= -2);

    assert(!(x < 100000000) && !(c_01*x0 + c_11*x <= d_1) && !(c_02*x0 + c_12*x <= d_2));
    //__VERIFIER_assume(-i + -t + -p <= -1);

    assert(!(x >= 100000000) && !(c_03*x0 + c_13*x <= d_3));
    //__VERIFIER_assume(-i + -t + -p <= -1);
